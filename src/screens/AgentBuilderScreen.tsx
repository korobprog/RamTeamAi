...
const roleOptions: Array<{ value: AgentRole; label: string; prompt: string }> = [
  ...
  { value: "tester", label: "\u0422\u0435\u0441\u0442\u0438\u0440\u043e\u0432\u0449\u0438\u043a", prompt: "\u041f\u043b\u0430\u043d\u0438\u0440\u0443\u0439 \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438, edge cases, \u0440\u0435\u0433\u0440\u0435\u0441\u0441\u0438\u044e \u0438 \u043a\u0440\u0438\u0442\u0435\u0440\u0438\u0438 \u0433\u043e\u0442\u043e\u0432\u043d\u043e\u0441\u0442\u0438." },
...
function createAgent(providers: ProviderConfig[], role: AgentRole = "architect"): AgentConfig {
  ...
  return {
    ...
    tokenBudget: 40_000,
    tools: role === "researcher" ? ["web-search", "mcp"] : role === "coder" ? ["files", "project-builder"] : ["files"],
    status: "waiting",
  };
}
...
export function AgentBuilderScreen() {
  ...
  function handleRoleChange(role: AgentRole) {
    ...
    patch({ role, name: option.label, systemPrompt: option.prompt });
  }
